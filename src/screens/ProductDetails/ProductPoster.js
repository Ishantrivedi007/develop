...
import Poster from "./images/3.jpg";
  ...
  return (
    <div className="totalpdpage">
      <Carousel slide={false} className="Carousel">
        <Carousel.Item>
          <img className="imagesize" src={Poster} alt="First slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="imagesize" src={Poster} alt="Second slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="imagesize" src={Poster} alt="Third slide" />
        </Carousel.Item>
      </Carousel>
      <div className="boxx">
